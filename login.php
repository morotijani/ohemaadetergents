  ...
  <div class="auth-form-side">
    <div class="auth-box">
      ...
      <div id="loginForm" class="form-flip active">
        ...
        <?php if (!empty($error)): ?>
          <div
            style="padding: 15px; background: #fee; border-left: 4px solid #c00; margin-bottom: 20px; font-size: 0.9rem; color: #c00;">
            <?php echo htmlspecialchars($error); ?>
          </div>
        <?php endif; ?>
        <?php if (!empty($success)): ?>
          <div
            style="padding: 15px; background: #efe; border-left: 4px solid #0c0; margin-bottom: 20px; font-size: 0.9rem; color: #0c0;">
        ...
        <form method="POST" action="">
          ...
          <div class="field">
            ...
            <input id="loginEmail" type="text" name="email"
              value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>" placeholder="you@email.com" required>
          </div>
          <div class="field">
          ...
          <div style="display:flex; justify-content:flex-end; margin-bottom:20px;">
            <a href="<?php echo BASE_URL; ?>forgot_password" class="link-quiet">Forgot password?</a>
          </div>
          <button class="form-submit btn-full" type="submit">Log in</button>
        </form>

        <p class="auth-foot">New to Ohemaa? <a href="#"
            onclick="document.querySelector('[data-tab=signupForm]').click(); return false;">Create an account</a></p>
      </div>

      <div id="signupForm" class="form-flip">

        <div id="registerAlert" class="alert d-none"
          style="padding: 15px; margin-bottom: 20px; font-size: 0.9rem; display: none;"></div>
        <form id="registerForm">
          ...
          <div class="field">
            ...
            <span style="font-size: 0.8rem; color: var(--grey); margin-top: 5px; display: block;">Minimum 8
              characters</span>
          </div>
          <div class="field-check">
            <input type="checkbox" id="suTerms" required>
            <label for="suTerms" style="margin:0; font-weight:500;">I agree to the Terms of Service and Privacy
              Policy.</label>
          </div>
          <button class="form-submit btn-full" type="submit">Create account</button>
        </form>
        <p class="auth-foot">Already have an account? <a href="#"
            onclick="document.querySelector('[data-tab=loginForm]').click(); return false;">Log in</a></p>
      </div>

      <p class="auth-foot" style="margin-top:32px;">Applying as a shop or business? <a
          href="<?php echo BASE_URL; ?>become_stockist">Become a stockist</a> instead.</p>
    </div>
  </div>
</div>
