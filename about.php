...
<section class="heritage">
    <div class="wrap heritage-grid" style="align-items: center;">
        <div class="heritage-copy reveal">
            <h2>Mission</h2>
            <p style="margin-bottom: 24px;">At Ohemaa Detergents, our mission is to provide high-quality, affordable
                cleaning
                solutions while promoting sustainability and innovation. We strive to enhance daily lives and ensure a
                cleaner,
                healthier environment for future generations.</p>

            <h2>Vision</h2>
            <p>To be a leading provider of innovative and sustainable cleaning solutions, recognized for our commitment
                to
        ...
        <div class="stat-cards reveal">
            ...
            <div class="stat-card"><span class="num">15+ yrs</span><span class="lbl">Formulating for Ghanaian
                    households</span></div>
            <div class="stat-card"><span class="num">200+</span><span class="lbl">Stockists carrying the full
                    range</span>
            </div>
            <div class="stat-card"><span class="num">SIC & MoH</span><span class="lbl">Trusted by top
                    institutions</span>
            </div>
        </div>
    </div>
...
<section style="background: var(--paper); padding-top: 80px; padding-bottom: 80px;">
    <div class="wrap">
        <div class="section-head reveal">
            ...
            <p style="max-width: 600px; margin: 16px auto 0; color: var(--text);">Our detergent is one of the best in
                Ghana
                and we have managed to provide services for companies like SIC, Ministry of Health, and others. Our team
                of
    ...
    <div class="wrap">
        ...
        <div class="value-grid" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
            ...
            <div class="value-card reveal">
                ...
                <h3>Quality</h3>
                <p>We are dedicated to producing high-quality products that meet the highest standards of our customers.
                </p>
            </div>
            <div class="value-card reveal">
                <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#E7C766" stroke-width="2">
...
<section class="stockists" style="background-color: rgb(220 53 69 / 22%) !important;">
    <div class="wrap" style="text-align:center;">
        <div class="reveal" style="max-width:560px; margin:0 auto;">
            ...
            <p style="margin:16px auto 28px;">We're expanding past the Ashanti Region — apply to become a stockist and
                we'll
