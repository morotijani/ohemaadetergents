...
<div class="auth-shell">
  <div class="auth-visual">
    ...
    <p>Make it something strong you haven't used on Ohemaa before — at least 8 characters, mixing letters and numbers.</p>
  </div>
  ...
  <div class="auth-form-side">
    <div class="auth-box">
      ...
      <div id="resetState">
        ...
        <p style="color:rgba(26,22,32,0.6); font-size:0.92rem; margin-bottom:28px;">Resetting password for <strong style="color:var(--ink);"><?php echo htmlspecialchars($customer['email']); ?></strong></p>
        ...
        <form id="resetPasswordForm">
          ...
          <div class="field pw-field">
            ...
            <input id="rpNew" name="new_password" type="password" placeholder="At least 8 characters" required minlength="8">
            <span class="pw-toggle">Show</span>
          </div>
          <div class="field pw-field">
            <label for="rpConfirm">Confirm new password</label>
            <input id="rpConfirm" name="confirm_password" type="password" placeholder="Re-enter password" required minlength="8">
            <span class="pw-toggle">Show</span>
          </div>
      ...
      <div id="doneState" style="display:none; text-align:center;">
        <div class="status-icon-circle" style="margin:0 auto 24px; background:rgba(30,110,99,0.15);">
          <svg viewBox="0 0 24 24" fill="none" stroke="#1E6E63" stroke-width="2"><path d="M9 12l2 2 4-4"/><circle cx="12" cy="12" r="9"/></svg>
        </div>
        <h3 style="font-size:1.3rem; margin-bottom:10px;">Password updated</h3>
        <p style="color:rgba(26,22,32,0.62); font-size:0.92rem; margin-bottom:26px;">Your password has been reset. Use your new password to log in.</p>
        <a href="login.html" class="btn btn-dark btn-full">Continue to log in</a>
      </div>
