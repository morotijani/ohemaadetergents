  ...
  <div class="auth-form-side">
    <div class="auth-box">
      ...
      <div id="requestState">
        ...
        <p style="color:rgba(26,22,32,0.6); font-size:0.92rem; margin-bottom:28px;">No worries — we'll send reset
      ...
      <div id="sentState" style="display:none; text-align:center;">
        ...
        <p style="color:rgba(26,22,32,0.62); font-size:0.92rem; margin-bottom:26px;">We've sent password reset
          instructions to your email if an account exists with that address.</p>
        <a href="login" class="btn btn-dark btn-full">I have reset my password.</a>
        <p class="auth-foot">Didn't get it? <a href="resend_verification">Resend or check spam</a></p>
      </div>
